    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            require_once 'config.php';
              if($_GET['id_data_pendidikan']) {
                $id_data_pendidikan = $_GET['id_data_pendidikan'];

                $sql = "SELECT * FROM tbl_pendidikan, tbl_pegawai WHERE id_data_pendidikan= {$id_data_pendidikan} ";
                ...
                <input type="text" class="form-control" name="id_data_pendidikan" disabled="true" value="<?php echo $data['id_data_pendidikan'] ?>" >
              </div>
              <div class="form-group">
                <label>Nama</label>
            ...
            <div class="col-sm-5" >
              ...
              <div class="form-group">
                  ...
                  <select name="pendidikan_akhir" class="form-control">
                    <option value="<?php echo $data['pendidikan_akhir'] ?>" <?php if($data['pendidikan_akhir'] == '<?php echo $data["pendidikan_akhir"];?>'){ echo 'selected';}?>><?php echo $data['pendidikan_akhir'];?></option>
                <?php
