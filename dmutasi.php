            ...
            <div class="row">
                <div class="col-lg-12"><br><br>
                    <div class="col-md-12 content"   style="background-color: #F8F8F8; border-radius: 10px;">
                      <div>
                          <a href="imutasi.php">  <br><button type="submit" class="btn btn-success"><i class='fa fa-plus fa-fw'></i>&nbsp; Masukan Data Baru</button> </a>
                     </div>
               <legend><Center>Data Mutasi Pegawai</Center></legend>
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td>".$row['no_sk']."</td>
                        <td>
                        <a href='emutasi.php?id_mutasi=".$row['id_mutasi']."'><button type='button'class='btn btn-primary'><i class='fa fa-pencil-square-o fa-fw'></i></button></a>
                         <a onClick=\"javascript: return confirm('Apakah yakin ingin di hapus?');\"href='hmutasi.php?id_mutasi=".$row['id_mutasi']."'><button type='button'class='btn btn-danger'><i class='fa fa-trash-o fa-fw'></i></button></a>
                        </td>
                    </tr>";
                     }
                     } else {
