            ...
            <div class="row">
                <div class="col-lg-12"><br><br>
                    <div class="col-md-12 content"  style="background-color: #F8F8F8; border-radius: 10px;"><br>
                            <legend><Center>Input Data Jabatan</Center></legend>
                      <div class="col-sm-8 content">
                      <form method="POST">
                <div class="form-group">
                <label for="">Id Jabatan</label>
                <input type="text" class="form-control" name="id_jabatan" placeholder="Masukan Id">
              </div>
              <div class="form-group">
                <label>Nama</label>
...
if($id_jabatan =='' || $nip =='' || $jabatan == '' || $tglmulai=='' || $blnmulai =='' || $tahunmulai == ''
|| $tglselesai=='' || $blnselesai =='' || $tahunselesai == '' ){
    ?>
   <script language="javascript" type="text/javascript">
                     alert("Maaf! field tidak boleh ada yang kosong.");
                     document.location='ijabatan.php';
                    </script>"   ;<?php
} else {
    
    $sql = "INSERT INTO `tbl_jabatan` (`id_jabatan`, `nip`, `jabatan`, `tglmulai`, `blnmulai`, `tahunmulai`, `tglselesai`, `blnselesai`, `tahunselesai`) VALUES ('$id_jabatan', '$nip', '$jabatan', '$tglmulai', '$blnmulai', '$tahunmulai','$tglselesai', '$blnselesai', '$tahunselesai');";
